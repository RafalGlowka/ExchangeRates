  ...
  private fun <INPUT : ScreenInput, OUTPUT : ScreenOutput> showFragment(
    ...
    if (fm == null) {
      ...
      fm.supportFragmentManager.commit {
        ...
        val fragment = fragmentFactory.createScreen(screen.screenStructure)
  ...
  override fun <INPUT : ScreenInput, OUTPUT : ScreenOutput> showDialog(
    ...
    if (fm == null) {
      ...
      fm.supportFragmentManager.commit {
        ...
        val dialogFragment = fragmentFactory.createScreenDialog(screenDialog.screenStructure)
