...
import com.glowka.rafal.exchange.domain.utils.pop
import com.glowka.rafal.exchange.domain.utils.push
import com.glowka.rafal.exchange.domain.utils.replace
...
fun <INPUT : ScreenInput, OUTPUT : ScreenOutput, SCREEN : Screen<INPUT, OUTPUT>>
    NavigationEvent.shouldBeNavigationPushToScreen(
  screen: SCREEN,
  onShowInput: INPUT?,
...
fun <INPUT : ScreenInput, OUTPUT : ScreenOutput, SCREEN : Screen<INPUT, OUTPUT>>
    NavigationEvent.shouldBeNavigationReplaceWithScreen(
  screen: SCREEN,
  onShowInput: INPUT?,
): NavigationEvent.ScreenNavigationEvent.ReplaceScreen<INPUT, OUTPUT, SCREEN> {
  this.shouldBeTypeOf<NavigationEvent.ScreenNavigationEvent.ReplaceScreen<INPUT, OUTPUT, SCREEN>>()
    .run {
      this.screen shouldBe screen
      this.onShowInput shouldBe onShowInput
    }
...
fun <INPUT : ScreenInput, OUTPUT : ScreenOutput, SCREEN : Screen<INPUT, OUTPUT>>
    NavigationEvent.ScreenNavigationEvent.ReplaceScreen<INPUT, OUTPUT, SCREEN>.emitScreenOutput(
  output: OUTPUT
): NavigationEvent.ScreenNavigationEvent.ReplaceScreen<INPUT, OUTPUT, SCREEN> {
  this.shouldBeTypeOf<NavigationEvent.ScreenNavigationEvent.ReplaceScreen<INPUT, OUTPUT, SCREEN>>()
    .onOutput(output)
